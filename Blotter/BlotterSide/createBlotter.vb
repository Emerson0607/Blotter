Public Class createBlotter
    ...
    Private Sub BtnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Else
            Try
              ...
              & "','" & vFullname.Text & "','" & vCitizenship.Text & "', '" & vGender.Text & "', '" & vBday.Value.Date.ToString("yyyy/MM/dd") & "', '" & vContactNumber.Text & "', '" & vAddress.Text & "')")
    ...
    'smooth scroll
    Private Sub Guna2ShadowPanel1_Scroll(sender As Object, e As ScrollEventArgs) Handles Guna2ShadowPanel1.Scroll
        If e.ScrollOrientation = ScrollOrientation.VerticalScroll Then
            Guna2ShadowPanel1.VerticalScroll.Value = e.NewValue
